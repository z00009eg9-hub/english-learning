...
,
    ...
    },
    {
      ...
      vocab: [
        { w: 'audit', star: true, ipa: '/ˈɑː.dɪt/', pos: 'n.', cn: '稽核(auditor 稽核員)', ex: 'the next formal audit', exCn: '下一次正式稽核' },
        ...
        { w: 'procedure', star: true, ipa: '/prəˈsiː.dʒɚ/', pos: 'n.', cn: '程序、步驟', ex: 'a safety procedure', exCn: '安全程序' },
      ...
      vocab2: [
        ...
        { w: 'defect', star: true, ipa: '/ˈdiː.fekt/', pos: 'n.', cn: '瑕疵、缺陷', ex: 'The inspector missed the defect.', exCn: '檢驗員漏看了那個瑕疵。' },
        { w: 'label', ipa: '/ˈleɪ.bəl/', pos: 'n.', cn: '標籤(載有產品資訊)', ex: 'a product label', exCn: '產品標籤' },
        ...
        { w: 'moisture absorber', star: true, ipa: '/ˈmɔɪs.tʃɚ əbˈzɔːr.bɚ/', pos: 'n.', cn: '吸濕劑(一般說法，好懂)', ex: 'check the moisture absorber', exCn: '檢查吸濕劑' },
        { w: 'desiccant', star: true, ipa: '/ˈdes.ɪ.kənt/', pos: 'n.', cn: '乾燥劑(較專業，發音較難)', ex: 'a desiccant pack', exCn: '一包乾燥劑' },
        { w: 'humidity', star: true, ipa: '/hjuːˈmɪdɪti/', pos: 'n.', cn: '濕氣、濕度', ex: 'absorb humidity', exCn: '吸收濕氣' },
