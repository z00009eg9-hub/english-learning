  ...
  lessons: [
    {
      ...
      vocab: [
        ...
        { w: 'elevator', ipa: '/ˈeləveɪtɚ/', pos: 'n.', cn: '電梯',
        ...
        { w: 'persuade', star: true, ipa:'/pɚˈsweɪd/', pos: 'v.', cn: '說服（＝ convince）',
        ...
        { w: 'pressure', star: true, ipa:'/ˈpreʃɚ/', pos: 'n.', cn: '壓力',
          ex: 'working under pressure', exCn: '在壓力下工作' },
        { w: 'overwhelmed', star: true, ipa:'/ˌoʊvɚˈwelmd/', pos: 'adj.', cn: '不知所措的、被壓垮的',
      ...
      vocab2: [
        ...
        { w: 'temperature', ipa: '/ˈtemprətʃɚ/', pos: 'n.', cn: '溫度（Celsius 攝氏）',
        ...
        { w: 'order', ipa: '/ˈɔːrdɚ/', pos: 'n.', cn: '訂單',
    ...
    },
    {
      ...
      vocab: [
        ...
        { w: 'persuade', star: true, ipa:'/pɚˈsweɪd/', pos: 'v.', cn: '說服（使人去做某事）',
          ex: 'She persuaded me to stay.', exCn: '她說服我留下來。' },
        { w: 'concern', ipa: '/kənˈsɝːn/', pos: 'n. / v.', cn: '擔心、關心',
          ex: 'Thank you for your concern.', exCn: '謝謝你的關心。' },
        { w: 'concerned', ipa: '/kənˈsɝːnd/', pos: 'adj.', cn: '擔心的、關切的',
        ...
        { w: 'temporary', star: true, ipa:'/ˈtempɚeri/', pos: 'adj.', cn: '暫時的（＝for a short time）',
      ...
      vocab2: [
        ...
        { w: 'deserve', star: true, ipa:'/dɪˈzɝːv/', pos: 'v.', cn: '值得、應得',
          ex: 'You deserve to win.', exCn: '你值得贏。' },
        { w: 'threaten', star: true, ipa:'/ˈθretən/', pos: 'v.', cn: '威脅',
      ...
      /* 索引表：只列片語＋中文＋詳見章節，不掛例句（SKILL.md「⭐ 內容去重原則」第 3 條），
         這些句子都已經在作業複習／句型／情境例句章節出現過。 */
      phrases: [
        { p: 'have a lot in common', cn: '有很多共同點（詳見 I 第 3 題 / VIII-A）' },
        { p: 'get to know somebody', cn: '逐漸認識、了解某人（詳見 I 第 3 題 / VIII-A）' },
        { p: "read each other's minds", cn: '心有靈犀、很有默契（詳見 I 第 5 題 / VIII-A）' },
        { p: 'build rapport with somebody', cn: '與某人建立融洽關係（詳見 I 第 2 題 / VIII-A）' },
        { p: 'have the same taste in …', cn: '在……方面品味相同（詳見 VIII-B）' },
        { p: 'keep something under control', cn: '把某事控制住（詳見 I 第 4 題）' },
        { p: 'be concerned about …', cn: '擔心、關切……（詳見 VIII-C）' },
        { p: 'be out of + 名詞', cn: '（東西）用完了、缺貨（詳見 VII-A）' },
        { p: 'run out of + 名詞', cn: '逐漸用光（詳見 VII-A）' },
        { p: 'be responsible for + N / V-ing', cn: '負責……（詳見 VII-C）' },
        { p: "That's all about …", cn: '關於……就講到這裡（詳見 VII-C）' },
        { p: 'manage to + 原形動詞', cn: '設法做到、成功做到（詳見 V-A）' },
        { p: 'give up + V-ing', cn: '放棄（做某事）（詳見 IV-B）' },
        { p: 'put off + V-ing', cn: '延後、拖延（做某事）（詳見 IV-B / VI-A）' },
        { p: 'put out + 受詞', cn: '撲滅（火、燈）（詳見 VI-A）' },
        { p: 'go on / carry on + V-ing', cn: '繼續（做某事）（詳見 IV-B）' },
        { p: 'keep / keep on + V-ing', cn: '一直、反覆（做某事）（詳見 IV-B）' },
        { p: 'keep somebody waiting', cn: '讓某人等著（詳見 IV-C）' },
        { p: 'keep breaking down', cn: '三天兩頭故障（詳見 IV-B）' },
        { p: 'be X hours ahead of / behind …', cn: '比……快／慢 X 小時（詳見 VIII-D）' }
      ],
    ...
    },
    {
      ...
      vocab: [
        ...
        { w: 'difference', ipa:'/ˈdɪfɚəns/', pos: 'n.', cn: '差異；差別',
        ...
        { w: 'confirm', ipa: '/kənˈfɝːm/', pos: 'v.', cn: '確認；核准',
        ...
        { w: 'purchase', star: true, ipa:'/ˈpɝːtʃəs/', pos: 'v. / n.', cn: '購買',
        ...
        { w: 'fortune teller', ipa: '/ˈfɔːrtʃən ˌtelɚ/', pos: 'n.', cn: '算命師',
    ...
    },
    {
      ...
      vocab: [
        ...
        { w: 'distraction', star: true, ipa:'/dɪˈstrækʃən/', pos: 'n.', cn: '使人分心的事物',
        ...
        { w: 'subfolder', ipa: '/ˈsʌbfoʊldɚ/', pos: 'n.', cn: '子資料夾',
        ...
        { w: 'construction', ipa: '/kənˈstrʌkʃən/', pos: 'n.', cn: '施工；建造',
          ex: 'The test room is still under construction.', exCn: '測試室還在施工中。' },
        { w: 'purchase', star: true, ipa:'/ˈpɝːtʃəs/', pos: 'v.', cn: '購買（buy 的正式說法）',
      ...
      vocab2: [
        { w: 'adapter', ipa: '/əˈdæptɚ/', pos: 'n.', cn: '轉接器／適配器',
    ...
    },
    {
      ...
      vocab: [
        ...
        { w: 'miscommunication', star: true, ipa:'/ˌmɪs.kə.mjuː.nɪˈkeɪ.ʃən/', pos: 'n.', cn: '溝通不良',
        ...
        { w: 'return period', ipa: '/rɪˈtɝːn ˈpɪriəd/', pos: 'n.', cn: '退貨期限',
          ex: 'The return period had expired.', exCn: '退貨期限已經過了。' },
        { w: 'failure', ipa: '/ˈfeɪl.jɚ/', pos: 'n.', cn: '失敗',
        ...
        { w: 'exposure', star: true, ipa:'/ɪkˈspoʊʒɚ/', pos: 'n.', cn: '曝光度',
        ...
        { w: 'expire', star: true, ipa:'/ɪkˈspaɪɚ/', pos: 'v.', cn: '到期、過期',
          ex: 'The return period had expired.', exCn: '退貨期限已經過了。' },
        ...
        { w: 'sponsor', ipa: '/ˈspɑːnsɚ/', pos: 'v.', cn: '贊助',
      ...
      vocab2: [
        ...
        { w: 'go viral', star: true, ipa:'/ɡoʊ ˈvaɪrəl/', pos: 'phr.', cn: '爆紅、瘋傳',
        ...
        { w: 'elaborate', star: true, ipa:'/ɪˈlæb.ɚ.eɪt/', pos: 'v.', cn: '詳細說明',
    ...
    },
    {
      ...
      vocab: [
        ...
        { w: 'sponsor', ipa: '/ˈspɑːnsɚ/', pos: 'n.', cn: '贊助商',
    ...
    },
    {
      ...
      vocab: [
        { w: 'landlord', ipa: '/ˈlændˌlɔːrd/', pos: 'n.', cn: '房東',
        ...
        { w: 'dispute', ipa: '/dɪˈspjuːt/', pos: 'n.', cn: '糾紛；爭執',
        ...
        { w: 'pressure', ipa: '/ˈpreʃɚ/', pos: 'n.', cn: '壓力（水壓）',
          ex: 'The water pressure in the shower is too low.', exCn: '淋浴間的水壓太低了。' },
        { w: 'ceiling', ipa: '/ˈsiːlɪŋ/', pos: 'n.', cn: '天花板',
        ...
        { w: 'minor', ipa: '/ˈmaɪnɚ/', pos: 'adj.', cn: '輕微的；次要的',
          ex: 'It was just a minor accident; no one was hurt.', exCn: '那只是一件小意外，沒有人受傷。' },
        { w: 'plumber', ipa: '/ˈplʌmɚ/', pos: 'n.', cn: '水電工；水管工',
...
,
    {
      ...
      vocab: [
        ...
        { w: 'let', ipa: '/let/', pos: 'v.', cn: '允許；讓（let + O + V 原形）',
          ex: 'Her parents let her go to the party.', exCn: '她的父母允許她去派對。' },
        { w: 'compel', star: true, ipa:'/kəmˈpel/', pos: 'v.', cn: '強迫；迫使',
        ...
        { w: 'sense of achievement', star: true, ipa:'/sens əv əˈtʃiːvmənt/', pos: 'phr.', cn: '成就感',
          ex: 'Cleaning my room gave me a sense of achievement.', exCn: '打掃房間給了我成就感。' },
        { w: 'responsible', ipa: '/rɪˈspɑːnsəbl/', pos: 'adj.', cn: '負責任的',
        ...
        { w: 'perform surgery on the patient', ipa: '/pɚˈfɔːrm ˈsɝː.dʒɚ.i ɑːn ðə ˈpeɪʃənt/', pos: 'phr.', cn: '對病人進行手術',
...
,
    {
      ...
      vocabTitle: 'I. 重點單字 Vocabulary',
      vocab: [
        { w: 'cosmetic surgery', star: true, ipa:'/kɑːzˈmetɪk ˈsɝːdʒɚi/', pos: 'n.', cn: '美容手術、整形手術',
          ex: 'Cosmetic surgery is becoming more common these days.', exCn: '現在整形手術越來越普遍。' },
        { w: 'cosmetic surgeon', star: true, ipa:'/ˌkɑːzˈmetɪk ˈsɝːdʒən/', pos: 'n.', cn: '整形外科醫師',
        ...
        { w: 'plastic surgery', ipa:'/ˈplæstɪk ˈsɝːdʒɚi/', pos: 'n.', cn: '整形手術（正式）',
...
,
    {
      ...
      vocab: [
        ...
        { w: 'surgery', star: true, ipa:'/ˈsɝːdʒɚi/', pos: 'n.', cn: '手術',
...
,
    {
      ...
      vocabTitle: 'I. 重點單字 Vocabulary',
      vocab: [
        { w: 'expression', ipa: '/ɪkˈspreʃ.ən/', pos: 'n.', cn: '表達方式；說法',
          ex: 'That is a common English expression.', exCn: '那是一句常見的英文說法。' },
        { w: 'gently', ipa: '/ˈdʒent.li/', pos: 'adv.', cn: '溫柔地；輕輕地',
          ex: 'Life goes more gently with money.', exCn: '有錢時生活過得比較溫和順心。' },
        { w: 'smoothly', ipa: '/ˈsmuːð.li/', pos: 'adv.', cn: '順利地；平穩地',
          ex: 'The project is running smoothly.', exCn: '這個專案進行得很順利。' },
        { w: 'root of all evil', ipa: '/ruːt əv ɔːl ˈiː.vəl/', pos: 'phrase', cn: '萬惡之源',
          ex: 'Greed is the root of all evil.', exCn: '貪婪是萬惡之源。' },
        { w: 'evil', ipa: '/ˈiː.vəl/', pos: 'n. / adj.', cn: '邪惡；壞事',
        ...
        { w: 'blackmail', star: true, ipa:'/ˈblæk.meɪl/', pos: 'n. / v.', cn: '勒索；敲詐',
          ex: 'He was arrested for blackmail.', exCn: '他因勒索被逮捕。' },
        { w: 'corruption', star: true, ipa:'/kəˈrʌp.ʃən/', pos: 'n.', cn: '貪污；腐敗',
          ex: 'Corruption hurts the economy.', exCn: '貪污傷害經濟。' },
        { w: 'slave labour', star: true, ipa:'/sleɪv ˈleɪ.bɚ/', pos: 'n.', cn: '奴工；強迫勞動',
...
,
    {
      ...
      vocab: [
        ...
        { w: 'doze off', star: true, ipa:'/doʊz ɑːf/', pos: 'v. phr.', cn: '打瞌睡；不知不覺睡著',
          ex: 'I dozed off during the long meeting.', exCn: '我在漫長的會議中不小心睡著了。' },
        { w: 'fall asleep', ipa: '/fɑːl əˈsliːp/', pos: 'v. phr.', cn: '睡著',
          ex: 'She fell asleep while reading.', exCn: '她看書時睡著了。' },
        { w: 'toss and turn', star: true, ipa:'/tɑːs ænd tɝːn/', pos: 'v. phr.', cn: '輾轉反側',
      ...
      vocab2: [
        ...
        { w: 'nightmare', ipa: '/ˈnaɪt.mer/', pos: 'n.', cn: '惡夢（動詞用 have）',
          ex: 'I had a nightmare that I was being chased.', exCn: '我做了一個被追趕的惡夢。（I had a nightmare last night. 我昨晚做了惡夢。）' },
        { w: 'have a restless night', ipa: '/hæv ə ˈrestləs naɪt/', pos: 'phr.', cn: '睡得不安穩',
...
,
    {
      ...
      vocab: [
        { w: 'heavy sleeper', star: true, ipa:'/ˈhevi ˈsliːpɚ/', pos: 'n. phr.', cn: '睡得很沉的人',
          ex: 'I am a heavy sleeper; nothing can wake me up.', exCn: '我是個睡得很沉的人，什麼都吵不醒我。' },
        { w: 'sleep like a log', star: true, ipa: '/sliːp laɪk ə lɑːɡ/', pos: 'idiom', cn: '睡得很香；沉睡',
        ...
        { w: 'treat all employees fairly', ipa: '/triːt ɔːl ɪmˈplɔɪiːz ˈferli/', pos: 'phr.', cn: '公平對待所有員工',
      ...
      vocab2: [
        ...
        { w: 'seafood / dessert', ipa: '/ˈsiːfuːd/；/dɪˈzɝːt/', pos: 'n.', cn: '海鮮／甜點',
        ...
        { w: 'gift voucher', star: true, ipa:'/ɡɪft ˈvaʊtʃɚ/', pos: 'n. phr.', cn: '禮券',
...
,
    {
      ...
      vocab: [
        ...
        { w: 'scooter', ipa: '/ˈskuːtɚ/', pos: 'n.', cn: '機車',
        ...
        { w: 'filter coffee', ipa: '/ˈfɪltɚ ˈkɔːfi/', pos: 'n.', cn: '濾泡式咖啡',
...
,
    {
      ...
      vocab: [
        { w: 'neighbor', ipa: '/ˈneɪbɚ/', pos: 'n.', cn: '鄰居',
        ...
        { w: 'rush hour', ipa: '/ˈrʌʃ aʊr/', pos: 'n.', cn: '尖峰時間',
...
,
    {
      ...
      vocab: [
        ...
        { w: 'make progress', ipa: '/meɪk ˈprɑː.ɡres/', pos: 'phr.', cn: '取得進步／進展',
...
,
    {
      ...
      vocab: [
        ...
        { w: 'keep a record of', ipa: '/kip ə ˈrekɚd ʌv/', pos: 'phr.', cn: '記錄',
        ...
        { w: 'experiment with', ipa: '/ɪkˈsperəmənt wɪθ/', pos: 'phr.', cn: '嘗試',
        ...
        { w: 'method', ipa: '/ˈmeθəd/', pos: 'n.', cn: '方法',
...
,
    {
      ...
      vocab: [
        ...
        { w: 'encouraging', ipa: '/ɪnˈkɝːɪdʒɪŋ/', pos: 'adj.', cn: '令人鼓舞的，給予希望的',
        ...
        { w: 'intermediate', ipa: '/ˌɪntɚˈmiːdiət/', pos: 'adj.', cn: '中級的',
...
,
    {
      ...
      vocab: [
        ...
        { w: 'burn incense', ipa: '/bɝːn ˈɪn.sens/', pos: 'v. phr.', cn: '焚香',
          ex: 'People burn incense to show respect.', exCn: 'incense 作名詞為「香」。' },
        { w: 'burn paper money', ipa: '/bɝːn ˈpeɪ.pɚ ˈmʌn.i/', pos: 'v. phr.', cn: '燒紙錢',
...
,
    {
      ...
      vocab: [
        ...
        { w: 'responsibility', ipa: '/rɪˌspɑːnsəˈbɪləti/', pos: 'n.', cn: '責任；職責',
          ex: 'They divide responsibilities.', exCn: '他們分配責任。' },
        { w: 'fairly', ipa: '/ˈferli/', pos: 'adv.', cn: '公平地',
        ...
        { w: 'celebrate', ipa: '/ˈsel.ɪ.breɪt/', pos: 'v.', cn: '慶祝',
        ...
        { w: 'community', ipa: '/kəˈmjuː.nə.ti/', pos: 'n.', cn: '社區；共同體',
...
,
    {
      ...
      vocab: [
        ...
        { w: 'motivated', ipa: '/ˈmoʊtɪveɪtɪd/', pos: 'adj.', cn: '有積極性的、有動機的',
          ex: 'I feel motivated.', exCn: '-ed 用於形容「人的感受」。' },
        { w: 'encouraging', ipa: '/ɪnˈkɝːɪdʒɪŋ/', pos: 'adj.', cn: '令人鼓舞的、鼓勵的',
          ex: 'The feedback was encouraging.', exCn: '這個回饋令人鼓舞。' },
        { w: 'frustrating', ipa: '/ˈfrʌstreɪtɪŋ/', pos: 'adj.', cn: '令人沮喪的、令人挫折的',
        ...
        { w: 'to be aware of', ipa: '/tu bi əˈwer ɑv/', pos: 'v. phr.', cn: '意識到…、注意到…',
          ex: 'I am aware of my mistakes.', exCn: 'aware 後面一定要接 of，用來銜接意識到的對象。' },
        { w: 'intermediate level', ipa: '/ˌɪntɚˈmidiɪt ˈlevḷ/', pos: 'n. phr.', cn: '中級程度',
...
,
    {
      ...
      vocab: [
        { w: 'assemble', ipa: '/əˈsembəl/', pos: 'v.', cn: '組裝／集合',
        ...
        { w: 'concentrate', ipa: '/ˈkɑːn.sən.treɪt/', pos: 'v.', cn: '專注／集中',
        ...
        { w: 'reject', ipa: '/rɪˈdʒekt/', pos: 'v.', cn: '拒絕／排斥',
        ...
        { w: 'transport', ipa: '/ˈtrænspɔːrt/', pos: 'v.', cn: '運輸／輸送',
        ...
        { w: 'refer', ipa: '/rɪˈfɝː/', pos: 'v.', cn: '提及／參考',
...
,
    {
      ...
      vocab: [
        ...
        { w: 'painkiller', ipa: '/ˈpeɪnˌkɪlɚ/', pos: 'n.', cn: '止痛藥（搭配：take a painkiller 吃止痛藥）',
          ex: 'She took a painkiller to weaken the migraine.', exCn: '她吃了一顆止痛藥來減緩偏頭痛。' },
        { w: 'boost', ipa: '/buːst/', pos: 'v.', cn: '提升、促進（搭配：boost my English skills）',
        ...
        { w: 'consult', ipa: '/kənˈsʌlt/', pos: 'v.', cn: '查閱、諮詢（consult the dictionary 查字典；💡 查字典不用 look 或 search）',
...
,
    {
      ...
      vocab: [
        ...
        { w: 'encouraging', ipa: '/ɪnˈkɝːɪdʒɪŋ/', pos: 'adj.', cn: '令人鼓舞的、給人希望的',
          ex: 'That was very encouraging.', exCn: '那非常令人鼓舞。' },
        { w: 'intermediate', ipa: '/ˌɪntɚˈmiːdiət/', pos: 'adj.', cn: '中級的、中階的',
...
,
    {
      ...
      vocab: [
        ...
        { w: 'leftover', ipa: '/ˈleftˌoʊvɚ/', pos: 'n. / adj.', cn: '剩下的食物',
        ...
        { w: 'bento meal', ipa: '/ˈbentoʊ mil/', pos: 'n. phr.', cn: '便當',
        ...
        { w: 'comforting', ipa: '/ˈkʌmfɚtɪŋ/', pos: 'adj.', cn: '令人感到安慰的、療癒的（「療癒美食」= comfort food）',
        ...
        { w: 'pesto sauce', ipa: '/ˈpestoʊ sɔs/', pos: 'n. phr.', cn: '青醬',
        ...
        { w: 'air fryer', ipa: '/er ˈfraɪr/', pos: 'n. phr.', cn: '氣炸鍋',
        ...
        { w: 'heavily flavored', ipa: '/ˈhevɪli ˈfleɪvɚd/', pos: 'adj. phr.', cn: '重口味的',
        ...
        { w: 'perishable', ipa: '/ˈperɪʃəbəl/', pos: 'adj.', cn: '易腐壞的（品管中有保存期限 shelf life 的原物料也可用）',
...
,
    {
      ...
      vocab: [
        ...
        { w: 'container', ipa: '/kənˈteɪnɚ/', pos: 'n.', cn: '容器',
        ...
        { w: 'power went out', ipa: '/ˈpaʊɚ went aʊt/', pos: 'v. phr.', cn: '停電',
...
,
    {
      ...
      vocab: [
        ...
        { w: 'sticky', ipa: '/ˈstɪki/', pos: 'adj.', cn: '黏膩的',
          ex: 'The air feels sticky or damp.', exCn: '高濕度在皮膚上引起的觸覺感受，汗水不易蒸發。' },
        { w: 'damp', ipa: '/dæmp/', pos: 'adj.', cn: '微濕的／潮濕的（霉菌生長的理想環境）',
...
,
    {
      ...
      vocab: [
        { w: 'thunderstorm', ipa: '/ˈθʌndɚstɔːrm/', pos: 'n.', cn: '雷雨、雷暴',
        ...
        { w: 'terrified', ipa: '/ˈterəˌfaɪd/', pos: 'adj.', cn: '感到極度恐懼的',
...
,
    {
      ...
      vocab: [
        ...
        { w: 'rare', ipa: '/rer/', pos: 'adj.', cn: '罕見的、稀少的',
          ex: 'Hail is rare in Taiwan.', exCn: '冰雹在台灣很罕見。' },
        { w: 'common', ipa: '/ˈkɑmən/', pos: 'adj.', cn: '常見的、普通的',
        ...
        { w: 'earrings', ipa: '/ˈɪrɪŋz/', pos: 'n.', cn: '耳環',
        ...
        { w: 'container', star: true, ipa:'/kənˈteɪnɚ/', pos: 'n.', cn: '容器、箱子',
          ex: 'Workers are checking the containers at the port.', exCn: '工人正在港口檢查貨櫃。' },
        { w: 'affect', star: true, ipa:'/əˈfekt/', pos: 'v.', cn: '影響',
...
,
    {
      ...
      vocab: [
        ...
        { w: 'razor', ipa: '/ˈreɪzɚ/', pos: 'n.', cn: '刮鬍刀',
...
,
    {
      ...
      vocab: [
        ...
        { w: 'rockfall', ipa: '/ˈrɑːk.fɑːl/', pos: 'n.', cn: '落石',
        ...
        { w: 'shower', ipa: '/ˈʃaʊr/', pos: 'n.', cn: '陣雨（短暫且可能很大的雨）',
...
,
    {
      ...
      vocab: [
        ...
        { w: 'topple', star: true, ipa:'/ˈtɑpəl/', pos: 'v.', cn: '推倒；倒塌',
      ...
      vocab2: [
        ...
        { w: 'bulldozer', star: true, ipa:'/ˈbʊldoʊzɚ/', pos: 'n.', cn: '推土機；挖土機',
        ...
        { w: 'volunteer', ipa: '/ˌvɑː.lənˈtɪr/', pos: 'n. / v.', cn: '義工；志願服務',
        ...
        { w: 'firefighter', ipa: '/ˈfaɪrfaɪtɚ/', pos: 'n.', cn: '消防員',
        ...
        { w: 'power outage', star: true, ipa:'/ˈpaʊɚ ˈaʊtɪdʒ/', pos: 'n.', cn: '停電（比 lose power 更正式的說法）',
...
,
    {
      ...
      vocab: [
        { w: 'natural disaster', ipa:'/ˈnætʃɚəl dɪˈzɑːstɚ/', pos: 'n.', cn: '天然災害',
        ...
        { w: 'volcano', ipa: '/vɑːlˈkeɪ.noʊ/', pos: 'n.', cn: '火山',
        ...
        { w: 'wildfire', star: true, ipa:'/ˈwaɪldfaɪɚ/', pos: 'n.', cn: '野火／山火',
        ...
        { w: 'blizzard', star: true, ipa:'/ˈblɪzɚd/', pos: 'n.', cn: '暴風雪',
          ex: 'The blizzard made it impossible to drive.', exCn: '暴風雪讓人根本無法開車。' }
      ],
      vocab2Title: '★ 新增單字（New from 06-18 Lesson）',
      vocab2: [
        { w: 'hurricane', star: true, ipa:'/ˈhɝː.ɪ.keɪn/', pos: 'n.', cn: '颶風（大西洋）',
        ...
        { w: 'landslide', star: true, ipa:'/ˈlændslaɪd/', pos: 'n.', cn: '土石流／山崩',
          ex: 'The typhoon triggered several landslides in the mountains.', exCn: '颱風在山區引發了數起土石流。' },
        { w: 'tectonic plates', star: true, ipa: '/tekˈtɑː.nɪk pleɪts/', pos: 'n.', cn: '板塊',
          ex: 'Taiwan sits on the boundary of several tectonic plates.', exCn: '台灣位於數個板塊的交界處。' },
        { w: 'magnitude', star: true, ipa: '/ˈmæɡ.nə.tuːd/', pos: 'n.', cn: '震級／規模',
          ex: 'The earthquake had a magnitude of 6.5.', exCn: '這場地震的規模為 6.5 級。' },
        { w: 'aftershock', star: true, ipa:'/ˈæf.tɚ.ʃɑːk/', pos: 'n.', cn: '餘震',
...
,
    {
      ...
      vocab: [
        ...
        { w: 'tsunami', ipa: '/tsuːˈnɑːmi/', pos: 'n.', cn: '海嘯',
        ...
        { w: 'wildfire', ipa: '/ˈwaɪldfaɪɚ/', pos: 'n.', cn: '野火／山火',
        ...
        { w: 'evacuate', ipa: '/ɪˈvækjueɪt/', pos: 'v.', cn: '撤離',
          ex: 'Residents were told to evacuate immediately.', exCn: '居民被告知立即撤離。' },
        { w: 'rescue', ipa: '/ˈreskjuː/', pos: 'v. / n.', cn: '救援',
...
,
    {
      ...
      vocab: [
        ...
        { w: 'return ticket', ipa: '/rɪˈtɝːn ˈtɪkɪt/', pos: 'n.', cn: '來回票',
        ...
        { w: 'passenger', ipa: '/ˈpæsɪndʒɚ/', pos: 'n.', cn: '乘客',
        ...
        { w: 'ticket counter', ipa: '/ˈtɪkɪt ˈkaʊntɚ/', pos: 'n.', cn: '售票櫃檯',
        ...
        { w: 'departure', star: true, ipa:'/dɪˈpɑːrtʃɚ/', pos: 'n.', cn: '出發、離開',
...
,
    {
      ...
      vocab: [
        { w: 'flight timetable', ipa: '/flaɪt ˈtaɪmˌteɪbəl/', pos: 'n.', cn: '航班時刻表',
          ex: 'I checked the flight timetable carefully.', exCn: 'a schedule showing flight times（顯示航班時間的時刻表）' },
        { w: 'departure', ipa: '/dɪˈpɑːrtʃɚ/', pos: 'n.', cn: '出發／起飛',
...
,
    {
      ...
      vocab: [
        ...
        { w: 'departure', ipa: '/dɪˈpɑːrtʃɚ/', pos: 'n.', cn: '出發、離開',
        ...
        { w: 'expire', star: true, ipa:'/ɪkˈspaɪɚ/', pos: 'v.', cn: '過期、到期',
          ex: 'My passport has expired.', exCn: '我的護照過期了。' },
        { w: 'renew', star: true, ipa:'/rɪˈnuː/', pos: 'v.', cn: '更新、續辦',
        ...
        { w: 'purpose', ipa: '/ˈpɝːpəs/', pos: 'n.', cn: '目的',
        ...
        { w: 'trolley', ipa: '/ˈtrɑː.li/', pos: 'n.', cn: '手推車',
...
,
    {
      ...
      vocab: [
        ...
        { w: 'trolley', ipa: '/ˈtrɑː.li/', pos: 'n.', cn: '行李推車',
      ...
      vocab2: [
        ...
        { w: 'plastic cutlery', star: true, ipa:'/ˈplæstɪk ˈkʌtlɚi/', pos: 'n.', cn: '塑膠餐具',
          ex: 'The meal came with plastic cutlery.', exCn: '餐點附了塑膠餐具。' },
        { w: 'soft drink', ipa: '/sɑːft drɪŋk/', pos: 'n.', cn: '汽水／無酒精飲料',
        ...
        { w: 'meal service', ipa: '/miːl ˈsɝːvɪs/', pos: 'n.', cn: '餐點服務',
        ...
        { w: 'window seat', ipa: '/ˈwɪndoʊ siːt/', pos: 'n.', cn: '靠窗座位',
        ...
        { w: 'window shade', ipa: '/ˈwɪndoʊ ʃeɪd/', pos: 'n.', cn: '遮光板',
          ex: 'Please keep your window shade open during landing.', exCn: '降落時請保持遮光板打開。' },
        { w: 'window blind', ipa: '/ˈwɪndoʊ blaɪnd/', pos: 'n.', cn: '窗簾／百葉窗',
          ex: 'She pulled down the window blind at home.', exCn: '她在家把百葉窗拉下來。' },
        { w: 'inconsiderate', star: true, ipa:'/ˌɪnkənˈsɪdɚət/', pos: 'adj.', cn: '不體貼的、不替別人著想的',
      ...
      extraVocab: [
        ...
        { k: 'tarmac ⭐ /ˈtɑːr.mæk/ n. 停機坪', en: 'We walked on the tarmac to board the plane.', cn: '我們走過停機坪登機。' },
...
,
    {
      ...
      vocab: [
        ...
        { w: 'approximately', star: true, ipa:'/əˈprɑk.sɪ.mət.li/', pos: 'adv.', cn: '大約',
        ...
        { w: 'overhead compartment', ipa: '/ˌoʊvɚˈhed kəmˈpɑːrtmənt/', pos: 'n.', cn: '頭頂置物櫃',
          ex: 'Please place your bag in the overhead compartment.', exCn: '請把行李放進頭頂置物櫃。' },
        { w: 'inconsiderate', star: true, ipa:'/ˌɪnkənˈsɪdɚət/', pos: 'adj.', cn: '不體貼的',
        ...
        { w: 'cutlery', star: true, ipa:'/ˈkʌtlɚi/', pos: 'n.', cn: '餐具（刀叉匙）',
          ex: 'Plastic cutlery is not good for hot food.', exCn: '塑膠餐具不適合裝熱食。' },
        { w: 'receptionist', ipa: '/rɪˈsepʃənɪst/', pos: 'n.', cn: '接待員',
          ex: 'The receptionist greeted us at the front desk.', exCn: '接待員在前台歡迎我們。' },
        { w: 'certainly', ipa: '/ˈsɝːtnli/', pos: 'adv.', cn: '當然（= sure）',
      ...
      vocab2: [
        ...
        { w: 'legroom', ipa: '/ˈleɡruːm/', pos: 'n.', cn: '伸腿空間',
        ...
        { w: 'check-in', ipa: '/ˈtʃekɪn/', pos: 'n.', cn: '報到手續',
          ex: 'Check-in opens two hours before the flight.', exCn: '報到手續在班機起飛前兩小時開始。' },
        { w: 'jet bridge / jetway', ipa: '/ˈdʒet brɪdʒ/', pos: 'n.', cn: '空橋',
          ex: 'Passengers board through the jet bridge.', exCn: '乘客經由空橋登機。' },
        { w: 'vegetarian', ipa: '/ˌvedʒəˈteriən/', pos: 'n.', cn: '素食者',
        ...
        { w: 'considerate', star: true, ipa:'/kənˈsɪdɚət/', pos: 'adj.', cn: '體貼的',
...
,
    {
      ...
      vocab: [
        ...
        { w: 'purchase', star: true, ipa:'/ˈpɝːtʃəs/', pos: 'v.', cn: '購買（較正式）',
        ...
        { w: 'underestimate', star: true, ipa:'/ˌʌndɚˈestɪmeɪt/', pos: 'v.', cn: '低估',
        ...
        { w: 'public holiday', ipa: '/ˈpʌb.lɪk ˈhɑː.lɪ.deɪ/', pos: 'n.', cn: '國定假日',
...
,
    {
      ...
      vocabTitle: 'I. 單字 Vocabulary',
      vocab: [
        { w: 'scenery', ipa: '/ˈsiː.nɚ.i/', pos: 'n.', cn: '風景、景色（不可數）',
        ...
        { w: 'sunburn', ipa: '/ˈsʌnbɝːn/', pos: 'n.', cn: '曬傷',
        ...
        { w: 'boat operator', ipa:'/boʊt ˈɑːpɚeɪtɚ/', pos: 'n.', cn: '船夫、開船的人',
...
,
    {
      ...
      vocab: [
        ...
        { w: 'filter coffee', ipa: '/ˈfɪltɚ ˈkɔːfi/', pos: 'n.', cn: '濾泡咖啡',
          ex: 'It takes me five minutes to make filter coffee.', exCn: '我泡濾泡咖啡要花五分鐘。' },
        { w: 'conical hat', ipa: '/ˈkɑː.nɪ.kəl hæt/', pos: 'n.', cn: '斗笠、圓錐帽',
        ...
        { w: 'optimist', star: true, ipa:'/ˈɑːptɪmɪst/', pos: 'n.', cn: '樂觀者、樂天派',
        ...
        { w: 'constantly', ipa: '/ˈkɑːnstəntli/', pos: 'adv.', cn: '不斷地',
          ex: 'He is constantly expecting a plane to drop on his head.', exCn: '他不斷擔心飛機會掉到頭上。' },
        { w: 'main character', ipa: '/meɪn ˈkærəktɚ/', pos: 'n.', cn: '主角',
...
,
    {
      ...
      vocabTitle: 'I. 單字 Vocabulary',
      vocab: [
        { w: 'elaborate', ipa: '/ɪˈlæb.ɚ.ət/ (adj.) /ɪˈlæb.ɚ.eɪt/ (v.)', pos: 'adj. / v.', cn: '精心製作的（adj.）／詳細說明（v.）',
        ...
        { w: 'greasy', ipa: '/ˈɡriː.si/', pos: 'adj.', cn: '油膩的',
        ...
        { w: 'encouragement', ipa: '/ɪnˈkɝː.ɪdʒ.mənt/', pos: 'n.', cn: '鼓勵',
...
,
    {
      ...
      vocabTitle: 'I. 單字 Vocabulary',
      vocab: [
        { w: 'effectively', ipa: '/ɪˈfektɪvli/', pos: 'adv.', cn: '有效地（達到正確目標）',
          ex: 'She communicates effectively with her team.', exCn: '她和團隊溝通很有效。' },
        { w: 'efficiently', ipa: '/ɪˈfɪʃəntli/', pos: 'adv.', cn: '有效率地（省時省力）',
        ...
        { w: 'passionate', ipa: '/ˈpæʃənət/', pos: 'adj.', cn: '充滿熱忱的',
        ...
        { w: 'elaborate', ipa: '/ɪˈlæb.ɚ.eɪt/', pos: 'v.', cn: '詳細說明',
        ...
        { w: 'optimist', ipa: '/ˈɑːptɪmɪst/', pos: 'n.', cn: '樂觀者',
    ...
    },
    {
      ...
      vocabTitle: 'II. 單字 Vocabulary',
      vocab: [
        { w: 'reputation', star: true, ipa:'/ˌrepjuˈteɪʃən/', pos: 'n.', cn: '名聲；聲譽',
        ...
        { w: 'threaten', star: true, ipa:'/ˈθretən/', pos: 'v.', cn: '威脅；恐嚇',
          ex: 'He threatened to call the police.', exCn: '他威脅要報警。' },
        { w: 'concern', ipa: '/kənˈsɝːn/', pos: 'n.', cn: '擔心；關切；問題',
    ...
    },
    {
      ...
      vocab: [
        { w: 'audit', star: true, ipa: '/ˈɑː.dɪt/', pos: 'n.', cn: '稽核(auditor 稽核員)', ex: 'The factory is getting ready for the next formal audit.', exCn: '工廠正在為下一次正式稽核做準備。' },
        { w: 'operator', ipa: '/ˈɑːpəreɪtɚ/', pos: 'n.', cn: '作業員、操作員', ex: 'The operator at this station checks every machine before packaging.', exCn: '這個工站的作業員在包裝前會檢查每一台機器。' },
        { w: 'station', ipa: '/ˈsteɪʃən/', pos: 'n.', cn: '工站', ex: 'Each operator is responsible for one station on the production line.', exCn: '每位作業員負責產線上的一個工站。' },
        { w: 'security', star: true, ipa: '/səˈkjʊrəti/', pos: 'n.', cn: '保全、安全(防入侵、防盜)', ex: 'The factory improved its security after the theft last year.', exCn: '去年失竊之後，工廠加強了保全。' },
        { w: 'safety', ipa: '/ˈseɪfti/', pos: 'n.', cn: '安全(防受傷、防事故)', ex: 'Safety training is required for every new operator.', exCn: '每位新進作業員都必須接受安全訓練。' },
        { w: 'measure', star: true, ipa: '/ˈmeʒɚ/', pos: 'n.', cn: '措施(常用複數)', ex: 'The company took new security measures after the audit.', exCn: '稽核之後，公司採取了新的安全措施。' },
        { w: 'machinery', star: true, ipa: '/məˈʃiːnɚi/', pos: 'n.', cn: '機械(不可數)', ex: 'Only trained workers may operate the heavy machinery.', exCn: '只有受過訓練的工人才可以操作重型機械。' },
        { w: 'priority', star: true, ipa: '/praɪˈɔːrəti/', pos: 'n.', cn: '優先事項', ex: 'Finishing the audit report is our top priority this week.', exCn: '完成稽核報告是我們這週最優先的事。' },
        { w: 'procedure', star: true, ipa: '/prəˈsiː.dʒɚ/', pos: 'n.', cn: '程序、步驟', ex: 'Every operator must follow the safety procedure step by step.', exCn: '每位作業員都必須一步一步遵守安全程序。' },
        { w: 'regulation', star: true, ipa: '/ˌreɡjəˈleɪʃən/', pos: 'n.', cn: '規定、法規', ex: 'A new safety regulation takes effect next month.', exCn: '一條新的安全規定下個月開始實施。' },
        { w: 'equipment', ipa: '/ɪˈkwɪpmənt/', pos: 'n.', cn: '設備(不可數)', ex: 'The company checks the safety equipment every three months.', exCn: '公司每三個月檢查一次安全防護設備。' },
        { w: 'glove', ipa: '/ɡlʌv/', pos: 'n.', cn: '手套', ex: 'The operator wears safety gloves when handling sharp parts.', exCn: '作業員在處理尖銳零件時會戴安全手套。' },
        { w: 'goggles', ipa: '/ˈɡɑːɡəlz/', pos: 'n.', cn: '護目鏡(包覆式，恆用複數)', ex: 'You must put on safety goggles before using the machine.', exCn: '使用這台機器前必須戴上護目鏡。' },
        { w: 'helmet', ipa: '/ˈhelmət/', pos: 'n.', cn: '頭盔、安全帽', ex: 'He forgot his helmet, so the guard stopped him at the gate.', exCn: '他忘了戴安全帽，所以警衛在大門口把他攔下來。' },
        { w: 'vest', ipa: '/vest/', pos: 'n.', cn: '背心', ex: 'The auditor put on a safety vest before entering the line.', exCn: '稽核員進產線前穿上了反光背心。' }
      ],
      vocab2Title: 'B. 組裝與包裝 Assembly & Packaging',
      vocab2: [
        { w: 'treadmill', ipa: '/ˈtredmɪl/', pos: 'n.', cn: '跑步機(running belt 跑步帶)', ex: 'We test every treadmill before it leaves the factory.', exCn: '每一台跑步機出廠前我們都會測試。' },
        { w: 'elliptical', star: true, ipa: '/ɪˈlɪptɪkəl/', pos: 'n.', cn: '滑步機', ex: 'This elliptical is much heavier than the treadmill.', exCn: '這台滑步機比跑步機重很多。' },
        { w: 'secure', star: true, ipa: '/səˈkjʊr/', pos: 'v.', cn: '固定、綁牢', ex: 'Please secure the cable with a tie before closing the cover.', exCn: '蓋上外蓋之前，請用束帶把線材固定好。' },
        { w: 'cable', ipa: '/ˈkeɪbəl/', pos: 'n.', cn: '電線、線材', ex: 'A loose cable inside the machine can cause a strange noise.', exCn: '機器裡鬆脫的線材可能會造成怪聲音。' },
        { w: 'tighten', ipa: '/ˈtaɪtən/', pos: 'v.', cn: '鎖緊(↔ loosen 鬆開)', ex: 'Please tighten the screws on the frame before testing.', exCn: '測試之前請把框架上的螺絲鎖緊。' },
        { w: 'loose', ipa: '/luːs/', pos: 'adj.', cn: '鬆的(≠ lose /luːz/ 遺失)', ex: 'The machine makes a noise because one part is loose.', exCn: '機器會有聲音，是因為有一個零件鬆了。' },
        { w: 'screw', ipa: '/skruː/', pos: 'n.', cn: '螺絲', ex: 'One screw is missing from the accessory box.', exCn: '配件盒裡少了一根螺絲。' },
        { w: 'edge', ipa: '/edʒ/', pos: 'n.', cn: '邊緣', ex: 'Be careful; the edge of the metal cover is very sharp.', exCn: '小心，金屬外蓋的邊緣很尖銳。' },
        { w: 'appearance', star: true, ipa: '/əˈpɪrəns/', pos: 'n.', cn: '外觀', ex: 'A small scratch can affect the appearance of the product.', exCn: '一道小刮痕就可能影響產品的外觀。' },
        { w: 'eyesore', star: true, ipa: '/ˈaɪsɔːr/', pos: 'n.', cn: '難看、礙眼的東西(口語，正式場合用 affect the appearance)', ex: 'The broken sign at the gate is a real eyesore.', exCn: '大門口那個壞掉的招牌真的很礙眼。' },
        { w: 'assemble', star: true, ipa: '/əˈsembəl/', pos: 'v.', cn: '組裝(n. assembly)', ex: 'It takes two people to assemble this machine.', exCn: '組裝這台機器需要兩個人。' },
        { w: 'accessory', star: true, ipa: '/əkˈsesɚi/', pos: 'n.', cn: '配件(隨產品附上的零件、工具、說明書等)', ex: 'Please check that no accessory is missing before packaging.', exCn: '包裝之前請確認沒有少任何配件。' },
        { w: 'defect', star: true, ipa: '/ˈdiː.fekt/', pos: 'n.', cn: '瑕疵、缺陷', ex: 'The customer returned the machine because of a defect.', exCn: '顧客因為一個瑕疵把機器退了回來。' },
        { w: 'label', ipa: '/ˈleɪ.bəl/', pos: 'n.', cn: '標籤(載有產品資訊)', ex: 'Please stick the label on the side of the box.', exCn: '請把標籤貼在箱子的側邊。' },
        { w: 'sticker', ipa: '/ˈstɪkɚ/', pos: 'n.', cn: '貼紙(泛指可黏貼的東西)', ex: 'Do not use a sticker instead of the product label.', exCn: '不要用貼紙代替產品標籤。' },
        { w: 'serial number', star: true, ipa: '/ˈsɪriəl ˌnʌmbɚ/', pos: 'n.', cn: '序號、流水號', ex: 'Every machine has its own serial number.', exCn: '每一台機器都有自己的序號。' },
        { w: 'cardboard', ipa: '/ˈkɑːrdbɔːrd/', pos: 'n.', cn: '紙板、瓦楞紙(cardboard box 紙箱)', ex: 'The accessory box is made of thin cardboard.', exCn: '配件盒是用薄紙板做的。' },
        { w: 'tape', ipa: '/teɪp/', pos: 'n.', cn: '膠帶', ex: 'We ran out of tape at the packaging station.', exCn: '包裝站的膠帶用完了。' },
        { w: 'seal', ipa: '/siːl/', pos: 'v.', cn: '密封、封起來', ex: 'Please seal the box before you put it on the pallet.', exCn: '請先把箱子封好，再放到棧板上。' },
        { w: 'staple gun', ipa: '/ˈsteɪpəl ɡʌn/', pos: 'n.', cn: '釘槍(把釘書針打進紙板、木頭)', ex: 'Be careful when you use the staple gun.', exCn: '使用釘槍的時候要小心。' },
        { w: 'moisture absorber', star: true, ipa: '/ˈmɔɪs.tʃɚ əbˈzɔːr.bɚ/', pos: 'n.', cn: '吸濕劑(一般說法，好懂)', ex: 'Put a moisture absorber inside the box before sealing it.', exCn: '封箱之前先在箱子裡放一包吸濕劑。' },
        { w: 'desiccant', star: true, ipa: '/ˈdes.ɪ.kənt/', pos: 'n.', cn: '乾燥劑(較專業，發音較難)', ex: 'Each box contains one desiccant pack.', exCn: '每個箱子裡放一包乾燥劑。' },
        { w: 'humidity', star: true, ipa: '/hjuːˈmɪdɪti/', pos: 'n.', cn: '濕氣、濕度', ex: 'High humidity can damage the machine during shipping.', exCn: '運送過程中濕度太高可能會損壞機器。' },
        { w: 'effective', ipa: '/ɪˈfektɪv/', pos: 'adj.', cn: '有效的', ex: 'This method is effective, and it saves a lot of time.', exCn: '這個方法很有效，也省下很多時間。' },
        { w: 'expired', ipa: '/ɪkˈspaɪɚd/', pos: 'adj.', cn: '過期的', ex: 'Please throw away the expired packs and open a new bag.', exCn: '請把過期的那幾包丟掉，開一包新的。' }
      ],
      phrasesTitle: 'III. 片語與搭配詞 Phrases & Collocations',
      phrases: [
    ...
    },
    {
      ...
      vocab: [
        ...
        { w: 'identify', star: true, ipa: '/aɪˈdentəˌfaɪ/', pos: 'v.', cn: '辨識；找出',
        ...
        { w: 'warehouse', ipa: '/ˈwerhaʊs/', pos: 'n.', cn: '倉庫',
    ...
    },
    {
      ...
      vocab: [
        ...
        { w: 'nervous', ipa: '/ˈnɝːvəs/', pos: 'adj.', cn: '緊張的',
    ...
    },
    {
      ...
      vocab: [
        ...
        { w: 'contact', ipa: '/ˈkɑːntækt/', pos: 'v.', cn: '聯絡（打電話、傳訊息或找到某人）',
          ex: 'I was in charge of contacting the IT department.', exCn: '我負責聯絡資訊部門。' },
        { w: 'concentrate', ipa: '/ˈkɑːn.sən.treɪt/', pos: 'v.', cn: '專注（＝ focus）',
